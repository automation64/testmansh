...
testmansh_initialize "$testmansh_command" "$testmansh_container" || exit 1
...
'run_linter') "testmansh_${testmansh_command}" "$testmansh_container" "$testmansh_format" "$testmansh_report" "$testmansh_case" ;;
'run_test') "testmansh_${testmansh_command}" "$testmansh_container" "$testmansh_format" "$testmansh_report" "$testmansh_debug_test" "$testmansh_case" ;;
